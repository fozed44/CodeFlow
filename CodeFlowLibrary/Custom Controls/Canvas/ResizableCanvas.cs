...
{     
    ...
    /// 
    //+  Purpose:
    ///     A canvas control that is resize-able. The control inherits from HightlightingCanvas, simply 
    ///     because this control only works when its parent is a canvas.
    /// </summary>
    public class ResizableCanvas : HighlightingCanvas
    {
        #region Construction

        static ResizableCanvas() {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ResizableCanvas), new FrameworkPropertyMetadata(typeof(ResizableCanvas)));
        }

        /// <summary>
        /// By default, a ResizableCanvas is re-sizable.
        /// </summary>
        ...
        Cursor GetCursor(cursor c) {
            switch (c) {
                case ResizableCanvas.cursor.EW:
                    return Cursors.SizeWE;
                case ResizableCanvas.cursor.NESW:
                    return Cursors.SizeNESW;
                case ResizableCanvas.cursor.NS:
                    return Cursors.SizeNS;
                case ResizableCanvas.cursor.NWSE:
