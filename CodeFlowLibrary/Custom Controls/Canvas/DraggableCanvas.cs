...
namespace CodeFlowLibrary.Custom_Controls
{
    ...
    /// 
    //+  Purpose:
    ///     A canvas control with the added functionality of being draggable within the boundaries
    ///     of its parent control.
    /// </summary>
    public class DraggableCanvas : ResizableCanvas
    {
        #region Construction
        ...
        /// </summary>
        /// <remarks>
        /// Monitors the Resizing property exposed by the ResizableNodeView class. If the Resizing
        /// property is true, do not allow the control to be dragged.
        /// 
        ...
        protected override void OnMouseLeftButtonDown(MouseButtonEventArgs e) {
            ...
            // Don't respond to the event if the mouse is not currently under our control.
        ...
        /// </summary>
        /// <remarks>
        /// The Resizing property of the ResizableNodeView control is monitored so that 
        /// Resizing take precedence over dragging, in other words, if the control is
        /// currently being resized, it cannot also be dragged.
        /// 
        ...
        protected override void OnMouseMove(MouseEventArgs e) {
            ...
            // Don't respond to the event if we do not have control of the
            // mouse.
